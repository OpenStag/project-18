      ...
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <div className="flex items-center">
          ...
          <span className="logo-text">
            <span className="trinity">Trinity</span> <span className="hospital">Hospital</span>
          </span>
        </div>
        <nav className="hidden md:flex space-x-6">
          ...
          <a href="#doctors" className="text-gray-600 hover:text-primary">Appointment</a>
        </nav>
        <button className="btn-primary px-4 py-2 rounded hidden md:block">Register</button>
